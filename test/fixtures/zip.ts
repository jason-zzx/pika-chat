/**
 * Minimal ZIP writer for building binary test fixtures (docx/xlsx are ZIP
 * packages). STORED entries only — the payloads are tiny, so compression would
 * buy nothing and would require pulling in a dependency for tests alone.
 */
